  ...
  return (
    <section id="shop" className="w-full px-4 sm:px-6 pb-16 pt-6 md:pt-8 bg-bright-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filter and Sort Bar */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 md:mb-12 gap-6 md:gap-4 w-full">
          {/* Categories */}
          <div className="flex flex-wrap md:flex-nowrap md:overflow-x-auto gap-2 scrollbar-hide w-full">
            {CATEGORIES.map(category => (
              <button
                ...
                className={`px-5 py-2.5 rounded-full font-bricolage text-sm whitespace-nowrap transition-colors ${
                  activeTab === category 
